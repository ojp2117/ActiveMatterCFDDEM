...
!    buffers are not sufficient, they are resized.                      !
!----------------------------------------------------------------------!
...
!......................................................................!
      ...
      if (imaxbuf < (1.0+0.5*des_buff_resize_factor)*lmaxcnt*iGhostPacketSize) then
         pbuf = imaxbuf
         imaxbuf = (1.0+des_buff_resize_factor)*lmaxcnt*iGhostPacketSize
         do lface = 1,2*dimn
...
!**************************************op***************************************************
               ...
               IF(PARTICLE_ORIENTATION) &
                  ORIENTATION(lcurpar,1:3) = INIT_ORIENTATION
...
!   perform halo exchange go sync ghost cell data.                     !
!----------------------------------------------------------------------!
      SUBROUTINE DESMPI_SEND_RECV_FIELD_VARS
